(function($) {
    ...
    function mediaQuery(nw) {
        ...
        var $ixh8yej3 = $('#ixh8yej3 > div');
        var $ix1cy8zhl = $('#ix1cy8zhl');

        if ( nw < 768 ) {
            console.log("DEBUF: w: 767...");
            if ( par.hasClass("x1q0g3np") ) {
                ...
                // Se borra el elemento del logo y el element final del nav.
                if ( $temp1 || $temp2) {
                    $ix2lah0s.remove();    
                    $ixl5mz7h.remove();
                } else {
                    $temp1 = $ix2lah0s.detach();
                    $temp2 = $ixl5mz7h.detach();
                }

                // Pasar divs ($ixh8yej3 > div) o moverlo a otro div.
                var dd = $ixh8yej3.detach().appendTo($ix1cy8zhl); 
                console.log("DEBUG: Reuslt : " + dd);
                if (dd) {
                    $ixh8yej3.remove();    
                } else {
                    $temp3 = $ixh8yej3.detach();
                }
            } 
        } else {
            if ( par.hasClass("xdt5ytf") ) {
                 ...
                 */
                $ix1cy8zhl.prepend($temp1);
                $ix1cy8zhl.append($temp2);

                //$('##ix1cy8zhl').append($temp3);
